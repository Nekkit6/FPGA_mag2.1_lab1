...
/* Definitions for peripheral SWITHES */
#define XPAR_SWITHES_BASEADDR 0x41200000
#define XPAR_SWITHES_HIGHADDR 0x4120FFFF
#define XPAR_SWITHES_DEVICE_ID 1
#define XPAR_SWITHES_INTERRUPT_PRESENT 0
#define XPAR_SWITHES_IS_DUAL 0
...
/* Canonical definitions for peripheral SWITHES */
#define XPAR_GPIO_1_BASEADDR 0x41200000
#define XPAR_GPIO_1_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_SWITHES_DEVICE_ID
